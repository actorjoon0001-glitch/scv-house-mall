---
name: ship-to-main
description: 이 저장소(메타하우스 사이트)의 표준 배포 절차. 변경 작업을 마쳤을 때, 또는 사용자가 "배포", "올려줘", "머지", "반영", "ship", "PR 만들어 머지" 등을 요청할 때 사용한다. 작업 브랜치에 커밋·푸시한 뒤 **항상 새 PR을 main으로 생성해 머지**한다. main에 직접 커밋하지 않는다.
---
